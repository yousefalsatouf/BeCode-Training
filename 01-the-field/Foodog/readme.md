...
Ce client voudrait accentuer sa présence sur internet via l'animation d'un blog, qui parle d'alimentation pour  chiens. Celui-ci s'appelle **FooDog**.  

Vous allez devoir réaliser l'intégration du site. 

Vous réaliserez :
- 1 page d'accueil (suivant le design)
- 1 page de présentation de votre équipe de développeur (vous êtes libre pour ce design). 

En bonus : 
- 1 single pour les articles (suivant le design)
...
1. Intégrez-y un champs de recherche en haut à droite de la page (le designer a oublié de le mettre!). Pour la recheche, une fenêtre modale devra apparaître lorsqu'on l'on cliquera sur la loupe. 
